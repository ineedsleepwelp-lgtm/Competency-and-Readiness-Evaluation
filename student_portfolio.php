...
<head>
    ...
    <style>
        ...
        body { display: flex !important; min-height: 100vh; overflow-x: hidden; margin: 0; }
        .sidebar { width: 250px; transition: all 0.3s ease-in-out !important; flex-shrink: 0 !important; position: relative !important; z-index: 1000; overflow: visible; }
        .sidebar-header { display: flex; align-items: center; padding: 20px; gap: 15px; color: white; }
        .sidebar a { display: flex; align-items: center; white-space: nowrap; }
        .sidebar a i { margin-right: 10px; width: 20px; text-align: center; }
        body.sidebar-collapsed .sidebar { width: 70px !important; }
        body.sidebar-collapsed .sidebar .nav-text, body.sidebar-collapsed .sidebar-header .sidebar-title { display: none; }
        body.sidebar-collapsed .sidebar a, body.sidebar-collapsed .sidebar-header { justify-content: center; padding-left: 0; padding-right: 0; }
        body.sidebar-collapsed .sidebar a i { margin-right: 0; font-size: 1.2rem; }
        body.sidebar-collapsed .sidebar-header i { font-size: 24px; }
        body.sidebar-collapsed .sidebar a { position: relative; }
        body.sidebar-collapsed .sidebar a:hover::after { content: attr(title); position: absolute; left: 75px; background: #2c3e50; color: white; padding: 5px 10px; border-radius: 4px; white-space: nowrap; font-size: 12px; z-index: 1001; pointer-events: none; }
        .main-content { transition: all 0.3s ease-in-out !important; flex: 1 !important; width: 100% !important; }
        .menu-toggle-btn { background: transparent; border: none; color: #2c3e50; font-size: 24px; cursor: pointer; margin-right: 15px; padding: 5px; transition: color 0.3s ease; display: inline-block !important; }
...
<body class="sidebar-collapsed">
    ...
    <script>
        ...
        // Sync editor content before submitting chat fallback
        if(chatForm) {
        ...
        // AI Loading Screen Overlay Trigger
