...
// 1. FILE READER FUNCTION (Reads the document for the Supervisor)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['generate_ai'])) {
        ...
        if (!empty($sub['file_path'])) {
            ...
            $file_content_msg .= $extracted_text;
            $file_content_msg .= "\n==============================\n";
        } else {
            $file_content_msg = "\n[SYSTEM: No file attached.]\n";
        }
...
<head>
    ...
    <style>
        ...
        .message.user .bubble { background: #8e44ad; color: white; border-bottom-right-radius: 2px; }
...
<?php include 'sidebar.php'; ?>
    ...
    <div class="main-content">
        ...
        <div class="eval-grid">
            <div class="context-card">
                ...
                <a href="<?php echo $sub['file_path']; ?>" target="_blank" class="btn btn-view" style="display:block; text-align:center;">Download File</a>
            </div>
                ...
                <form method="POST" enctype="multipart/form-data" style="margin-bottom:30px;">
                    <div class="eval-card">
                        ...
                        <div class="eval-body">
                            ...
                            <div class="modern-input-group"><label class="modern-label">Feedback</label><textarea name="notes" class="modern-textarea" rows="6"><?php echo htmlspecialchars($ai_suggestion); ?></textarea></div>
                ...
                <div class="eval-card" style="border:2px solid #8e44ad;">
                    ...
                    <div class="chat-container">
                        <div class="chat-history" id="chatHistory">
                            ...
                            <?php endwhile; else: ?>
                                <div class="message ai"><div class="bubble">Hello Supervisor. I can read the attached file and description. How can I help?</div></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="chat-input-area">
                            ...
                            <button type="button" onclick="sendMessage()" class="btn-ai-glow" style="background:#8e44ad; color:white; width:auto; border-radius:50%; padding:12px;"><i class="fas fa-paper-plane"></i></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            formData.append('student_file_path', studentFilePath); // Pass file path
